...
! Before your first reply: read `%APPDATA%\deft\USER.md` (Windows) or `~/.config/deft/USER.md` (Unix). **Personal** wins over Deft defaults, skills, and this file.
...
GhostCopyeditor — copy editor for the Ghost writing suite (grammar, garbled text, and related checks via LLM, TypeSafe.ai, and deterministic code).
...
<!-- deft:managed-section v3 sha=0.118.1 refreshed=2026-09-21T14:26:54Z session=e1964a2206aa -->
